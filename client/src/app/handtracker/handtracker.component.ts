  ...
  runDetection(){
    if (this.model != null){
        let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            if (openhands === 1 && pointing === 1) this.detectedGesture = "1 Hand Pointing, 1 Open Hand"

            if (closedhands === 1 && pointing === 1) this.detectedGesture = "1 Hand Pointing, 1 Closed Hand"
